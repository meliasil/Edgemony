...
function App() {
  ...
  return (
    <main className="flex justify-center p-32">
      <div className="bg-neutral-white w-200px rounded-xl">
        <div className="flex flex-row gap-4 p-8">
          <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-lg">
              <h1 className="text-2xl font-bold sm:text-3xl text-neutral-darkSlateGrey">
                {labels.stayUpdated}
              </h1>

              <p className="mt-4 text-neutral-darkSlateGrey font-medium">
                {labels.join}
              </p>
              <br />
              <ul className="flex flex-col gap-4">
                <li className="flex flex-row gap-2 text-neutral-darkSlateGrey font-medium">
                  <svg
            ...
            <form action="#" className="mx-auto mb-0 mt-8 max-w-md space-y-4">
              <div>
                <h1 className="text-neutral-darkSlateGrey font-medium">
                  {labels.emailAddress}
                </h1>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-lg border-neutral-charcoalGrey p-4 pe-12 text-sm shadow-sm"
              ...
              <div className="flex items-center justify-center">
                <button
                  ...
                  type="submit"
                  className="inline-block rounded-lg bg-neutral-darkSlateGrey w-full px-5 py-3 text-sm font-medium text-white"
                >
                  {labels.subscribe}
                </button>
              </div>
